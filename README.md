...
Small, unofficial Node client for ESPN's NHL data. ESPN serves NHL
under `hockey/nhl`, and this wraps those endpoints.

Part of the [espn-api](https://github.com/LeSingh1/espn-api) family. The parent
repo is one client for every sport. This one is just NHL, in the style of
...
cd nhl-api
node examples/scoreboard.js   # NHL games on the board
